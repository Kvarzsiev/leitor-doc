...
public class RendimentoNaoTributavelIsento {
	...
	public RendimentoNaoTributavelIsento(String razao, String valor, String cnpjFontePagadora, String fontePagadora,
			String total) {
		super();
		this.razao = razao;
		this.valor = valor;
